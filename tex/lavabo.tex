...
\begin{itemize}
  \item \mintinline[bgcolor=grey]{bash}{ssh user@lavabo.server.com "my_command"}
...
\begin{enumerate}
  \item \mintinline[bgcolor=grey]{bash}{lavabo list}, to get the list of boards in the lab,
  \item \mintinline[bgcolor=grey]{bash}{lavabo reserve am335x-boneblack_01}, to put the board named \textit{am335x-boneblack\_01} virtually outside of the lab (offline in LAVA),
  \item \mintinline[bgcolor=grey]{bash}{lavabo upload kernel}, to upload the file name \textit{kernel} in the user's TFTP directory,
  \item \mintinline[bgcolor=grey]{bash}{lavabo serial am335x-boneblack_01}, to connect to the board named \textit{am335x-boneblack\_01},
  \item \mintinline[bgcolor=grey]{bash}{lavabo reset am335x-boneblack_01}, to reset power of the board named \textit{am335x-boneblack\_01},
  \item \mintinline[bgcolor=grey]{bash}{lavabo power-off am335x-boneblack_01}, to power off the board named \textit{am335x-boneblack\_01},
  \item \mintinline[bgcolor=grey]{bash}{lavabo release am335x-boneblack_01}, to virtually put back the board named \textit{am335x-boneblack\_01} in the lab (online in LAVA);
\end{enumerate}

It is possible to use autocompletion to get the name of a board or to store the name of the board in an environment variable name \mintinline[bgcolor=grey]{bash}{LAVABO_BOARD} with the following line: \mintinline[bgcolor=grey]{bash}{export LAVABO_BOARD=am335x-boneblack_01}
